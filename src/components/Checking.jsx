      ...
      <Fade left>
        ...
        <Bounce right cascade>
          <div className='xl:max-w-[400px] md:max-w-[300px] flex flex-col space-y-4 justify-center items-center md:items-start'>
            <h1 className='font-semibold mt-2 text-3xl text-[#013B52] text-center md:text-left md:text-2xl'>Let me know your mental health condition</h1>
            ...
            <div>
              <Link to='/getsupport/mentalcheck' className='bg-[#013B52] hover:bg-green-500 duration-500 px-4 py-3 md:px-6 md:py-3 text-sm xl:text-ls my-4 rounded-full text-white'>Start Checking </Link>
            </div>
          </div>
        </Bounce>
    </div>
